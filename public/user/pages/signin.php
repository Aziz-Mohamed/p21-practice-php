...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            redirect_to(url_for('/user/pages/home.php'));
...
<form method="POST" action="<?php echo url_for('/user/pages/signin.php'); ?>" class="max-w-md mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
  <div class="mb-4">
